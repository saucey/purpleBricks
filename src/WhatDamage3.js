      ...
      <div class="wmnds-col-1 wmnds-p-lg wmnds-bg-white">
        ...
        <Checkboxes
          ...
          options={[
            {
              checked: false,
              label: 'Height barrier is damaged, open or unlocked',
              value: 'option1'
            },
            {
              checked: false,
              label: 'Bollards are damaged or missing',
              value: 'option2'
            },
            {
              checked: false,
              label: 'Signage is damaged or missing',
              value: 'option3'
            },
            {
              checked: false,
            ...
            {
              checked: false,
              label: 'There is snow or ice',
              value: 'option1'
            },
            {
              checked: false,
              label: 'Footway or steps are damaged',
              value: 'option2'
            },
            {
              checked: false,
              label: 'Road surface is damaged',
              value: 'option3'
            },
            {
              checked: false,
              label: 'Speed humps are damaged',
              value: 'option3'
            },
            {
              checked: false,
              label: 'Road markings are damaged',
              value: 'option3'
            },
            {
              checked: false,
              label: 'A fence is damaged',
              value: 'option3'
            },
          ]}
          title=""
