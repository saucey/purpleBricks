...
const ButtonPayment = ({
  ...
  })), hasRightIcon && /*#__PURE__*/React.createElement("svg", {
    className: "wmnds-btn__icon wmnds-btn__icon--right",
...
const Radios = ({
  ...
  }, errorMessage || 'Please select an option'), /*#__PURE__*/React.createElement("span", {
    className: "wmnds-fe-radios__desc"
  }, descriptionText || 'Select all options that apply'), options.map((option, index) => /*#__PURE__*/React.createElement("label", {
    key: index,
...
const TextInput = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    htmlFor: finalId
  }, label), isError && /*#__PURE__*/React.createElement("span", {
    className: "wmnds-fe-error-message"
...
const FormTextarea = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "wmnds-fe-error-message"
  }, errorMessage), /*#__PURE__*/React.createElement("textarea", _extends({
...
const Checkboxes = ({
  ...
  }, title), options.map((option, index) => /*#__PURE__*/React.createElement("label", {
    key: index,
...
const Dropdown = ({
  ...
  }, updatedOptions.map(option => /*#__PURE__*/React.createElement("option", {
    key: option.value,
    value: option.value
  }, option.label)))));
};
